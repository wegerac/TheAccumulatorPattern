...
def run_test_factorial():
    ...
    # Test 1:
    answer_from_oracle = ma.factorial(0)
    answer_from_my_code = factorial(0)
    print('Test 1 expected (from oracle):', answer_from_oracle)
    print('       actual (from my code): ', answer_from_my_code)

    # Test 2:
    answer_from_oracle = ma.factorial(21)
...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 0
    answer = count_cosines_from(16, 22, 1)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 1
    answer = count_cosines_from(1, 2, 0)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 14
    answer = count_cosines_from(52, 82, 0.1)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 4:
    expected = 0.583  # This is APPROXIMATELY the correct answer.
